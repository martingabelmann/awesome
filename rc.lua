...
if wp_index ~= "theme" then
    ...
    if awful.util.file_readable(theme_dir .. "/background.png") then
        wp_path = theme_dir
        wp_files[1] = "/background.png"
    elseif awful.util.file_readable(theme_dir .. "/background.jpg") then
        wp_path = theme_dir
        wp_files[1] = "/background.jpg"
    else
        wp_path = "/usr/share/awesome/themes/default/"
        wp_files[1] = "background.png"
    end 
    wp_count = 1
end
